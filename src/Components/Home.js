...
const Home=()=>{
    ...
    return(
        <>
            <div className={`  h-30 p-6 gap-2 items-center justify-between font-semibold text-4xl outline-white flex ${Theme==='white' ? 'bg-gray-100 text-gray-900' : 'bg-gray-800 text-white'} border-b-gray-500 border-black shadow-lg rounded-md`}style={{border:'2px solid gray'}} >
                ...
                <div className="gap-4 flex flex-row">
                    ...
                    <FileDownloader  className="px-1 text-xl p-2  m-2 rounded-lg" props={expenseRedux} />
                    <button className=" mt-4 px-1 text-2xl flex gap-1  p-2   rounded-lg" onClick={logout} ><FiLogOut className="m-1"/> Log Out</button>
            ...
            {currentRight===1 &&  <Expenseshower HandlePdfDownload={HandlePdfDownload} /> }
