    ...
    async function hanldeSubmit(e){
        try{
          const obj = {Email:e.target.email.value, Password:e.target.password.value}
            ...
            localStorage.setItem('token',response._tokenResponse
              .idToken)
              ...
              <div className={classes.form}>
                ...
                <img className='rounded-full size-48 ml-32' src={logimage}></img>
                    ...
                    <h2 className='text-white text-3xl mb-2' >Log in</h2>
                      ...
                      <input id='password' placeholder='Password'  type='password'required></input>
                      <button type='submit' className='mb-2'>Submit</button>
                    </div>
                </form>
                <button style={{background:'lightgreen'}} className={classes.create} onClick={()=>{hanldetoggle()}}>Create A new account</button>
          ...
          <div className={classes.loginpage}>
            <div className={classes.form}>
              ...
              <div >
                ...
                <input id='password' placeholder='Password' type='password' minLength={6} required></input>
                <input id='password2' placeholder='Confirm Password' type='password' required></input>
                <button type='submit ' className='mb-2'>Submit</button>
              </div>
            </form>
