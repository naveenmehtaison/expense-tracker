    ...
    <div className="bg-gray-900  h-full" style={{ backgroundColor: Theme }}>
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <div className="w-52 h-1 bg-teal-500 mx-auto mb-8"></div>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Passionate developer creating solutions that bridge technology and
            human needs
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-300">
              <p>
                With {new Date().getFullYear() - 2023}+ years in software
                development, I've cultivated expertise in full-stack JavaScript
                development, specializing in React, Node.js, and modern web
                architectures.
              </p>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-wrap gap-3">
                {["React", "Node.js", "TypeScript", "AWS", "UI/UX Design"].map(
                  (skill) => (
                    <span
                      key={skill}
